...
// console.log(`is this person adult? ${isAdult}. is this person eldery? ${isElderly}. `)
...
if(personAge < 18) {
    ...
    console.log(`this person is eldery`);
}
...
let  lyric = `soomaaliyey toosoo`;
let includesLove = lyric.includes("love");
let includesHeart = lyric.includes("heart")
console.log(includesLove)

let isTypical = includesLove || includesHeart;

let isVeryTypical = includesLove && includesHeart;

console.log(`is typical: ${isTypical}, is very typical: ${isVeryTypical}`)
/*
